...
void DayZPlayerTypeRegisterItems(DayZPlayerType pType)
{
	...
	//! Clothes
		...
		pType.AddItemInHandsProfileIK("Chainmail",						"dz/anims/workspaces/player/player_main/player_main_1h.asi",						toolsOneHanded,					"dz/anims/anm/player/ik/clothing/ReflexVest.anm");
	...
	//! Headgear
	{
		...
		pType.AddItemInHandsProfileIK("Chainmail_Coif",					"dz/anims/workspaces/player/player_main/player_main_1h.asi",						toolsOneHanded,					"dz/anims/anm/player/ik/gear/dirtbike_visor.anm");
	}
